...
namespace Tool
{
    ...
    {
        public static readonly string WeChatAppId = "WeiXinAppId";
        public static readonly string WeChatSecret = "WeiXinAppSecret";
        public static readonly string WeChatToken = "WeiXinToken";
        public static readonly string DoMain = "DoMain";
        public static readonly string SendGift = "SendGift";
