...
namespace CSMP.Model
{
    public class PowerInfo
    {
            ...
            public enum P1_Call { 新建报修 = 101, 记录查看, 跟进处理, 转派, 回访, 删除记录, 编辑记录, 查看组内所有报修, 处理组内所有报修, 关闭报修, 查询不同状态报修, 数据导出, 店铺催促, 操作回滚, 批量报修, 处理记录编辑, 安排上门, 备件记录 };
            public enum P2_Manager { 日志管理 = 201, 数据导入, 系统信息, 系统设置,文件查看,文件删除,文件上传 };
            public enum P3_BaseData { 客户品牌管理 = 301, 故障类管理, 地区管理, 店铺查看, 店铺管理, 优先级管理,第三方管理,常用收件人,文件管理,文件删除,JobCode管理,工作周期管理,服务类型管理 };
