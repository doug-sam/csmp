<%@ page title="" language="C#" masterpagefile="~/Controls/Site1.master" autoeventwireup="true" inherits="page_WorkGroupEmail_view, App_Web_o6ipq5v3" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
           ...
           <tr>
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="选择">
                            <ItemTemplate>
                                ...
                                <input type="checkbox" name="ckDel" value='<%# Eval("ID")%>' <asp:Literal ID="LtlMakeItCheck" runat="server"></asp:Literal> />
                            </ItemTemplate>
            ...
            <td class="td1_2" valign="top">
                ...
                <asp:GridView ID="GridView2" Width="100%" CssClass="table2" runat="server" AutoGenerateColumns="false"
                    GridLines="Vertical"  OnRowDataBound="GridView2_RowDataBound">
                    <RowStyle CssClass="GV_RowStyle" />
                    <HeaderStyle CssClass="GV_HeaderStyle" />
                    <AlternatingRowStyle CssClass="GV_AlternatingRowStyle" />
                    <Columns>
                        <asp:TemplateField HeaderText="选择">
                            <ItemTemplate>
                                <input type="checkbox" name="ckEmailGroup" value='<%# Eval("ID")%>'  <asp:Literal ID="LtlMakeItCheck" runat="server"></asp:Literal> />
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Center" />
                        </asp:TemplateField>
