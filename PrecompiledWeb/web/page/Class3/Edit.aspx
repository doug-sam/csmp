<%@ page title="" language="C#" masterpagefile="~/Controls/Site1.master" autoeventwireup="true" inherits="page_Class3_Edit, App_Web_m430qfmr" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
            ...
            <table cellpadding="0" cellspacing="0" width="100%" border="0" class="table1">
                <tr>
                    <td colspan="2" style="height: 30px" class="td1_1">
                        <asp:Label ID="LabAction" runat="server" Text="新建"></asp:Label>小类
                    </td>
                </tr>
                <tr>
                    <td class="td1_2">
                ...
                <tr>
                    ...
                    <td class="td1_3">
                        <asp:DropDownList ID="DdlPriority" runat="server" DataTextField="Name" DataValueField="ID">
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="td1_3">
                        <asp:TextBox ID="TxbSla" runat="server"></asp:TextBox>(请输入数字)
                    </td>
                </tr>
                <tr>
                    <td class="td1_2">
