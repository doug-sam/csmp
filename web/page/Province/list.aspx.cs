...
public partial class page_Province_list : _BaseData_ProvinceCity
{
    ...
    private void Sch()
    {
        ...
        GridView1.DataSource = ProvincesBLL.GetList(PageSize, PageIndex, strWhere, out count);
        GridView1.DataBind();
