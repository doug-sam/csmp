...
public partial class page_Report_ProjectManagerReport_PMDateToDateReport_Brand : _Report_ReportPMDTDBrand
{
    ...
    protected void BindGridView()
    {
        ...
        if (BrandID == 0)
        {
            strSQL += "SELECT f_CustomerName,'' as f_BrandName,";
        }
        else
        {
            strSQL += "SELECT f_CustomerName,f_BrandName,";
        }
        strSQL += "COUNT(*) '开单总量',";
        ...
        if (BrandID == 0)
        {
            strSQL += " GROUP BY f_CustomerName";
        }
        else
        {
            strSQL += " GROUP BY f_CustomerName,f_BrandName";
        }
