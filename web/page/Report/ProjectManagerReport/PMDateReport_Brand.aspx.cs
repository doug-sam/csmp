...
public partial class page_Report_ProjectManagerReport_PMDateReport_Brand : _Report_ReportPMDBrand
{
    ...
    protected void BindGridView()
    {
        ...
        if (BrandID == 0)
        {
            strSQL += "SELECT f_CustomerName,CONVERT(VARCHAR(10),f_CreateDate,120) '时间','' as f_BrandName,";
        }
        else
        {
            strSQL += "SELECT f_CustomerName,CONVERT(VARCHAR(10),f_CreateDate,120) '时间',f_BrandName,";
        ...
        if (BrandID == 0)
        {
            strSQL += " GROUP BY CONVERT(VARCHAR(10),f_CreateDate,120),f_CustomerName";
        }
        else
        {

            strSQL += " GROUP BY CONVERT(VARCHAR(10),f_CreateDate,120),f_CustomerName,f_BrandName";
        }

        strSQL += " order by CONVERT(VARCHAR(10),f_CreateDate,120)";
