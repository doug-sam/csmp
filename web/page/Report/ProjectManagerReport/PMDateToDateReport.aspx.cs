...
public partial class page_Report_ProjectManagerReport_PMDateToDateReport : _Report_ReportPMDTDClass
{
    ...
    {
        DateBegin = Function.ConverToDateTime(TxtDateBegin.Text.Trim());
        DateEnd = Function.ConverToDateTime(TxbDateEnd.Text.Trim());
        ...
        if (BrandID == 0)
        {
            strSQL += "SELECT f_CustomerName,'' as f_BrandName,f_ClassName1,f_ClassName2,";
        }
        else
        {
            strSQL += "SELECT f_CustomerName,f_BrandName,f_ClassName1,f_ClassName2,";
        ...
        if (BrandID == 0)
        {
            strSQL += " GROUP BY f_CustomerName,f_ClassName1,f_ClassName2";
        }
        else
        {
            strSQL += " GROUP BY f_CustomerName,f_BrandName,f_ClassName1,f_ClassName2";
        }
        strSQL += " order by f_ClassName1";
