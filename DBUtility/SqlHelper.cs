...
namespace DBUtility
{
    ...
    public abstract class SqlHelper
    {
        ...
        /// 连接字符串
        /// </summary>
        public static readonly string SqlconnString = ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString;
        public static readonly string CCRecordSqlconnString = ConfigurationManager.ConnectionStrings["ConnCCRecord"].ConnectionString;
        //public static readonly string ConnectionString = SqlconnString;
        ...
        public static int ExecuteNonQuery(string cmdText, out int rel, params SqlParameter[] cmdParams)
        {
            ...
            using (SqlConnection conn = new SqlConnection(SqlconnString))
            {
                PrepareCommand(cmd, conn, null, CommandType.StoredProcedure, cmdText, cmdParams);//通过PrePareCommand方法将参数逐个加入到SqlCommand的参数集合中
